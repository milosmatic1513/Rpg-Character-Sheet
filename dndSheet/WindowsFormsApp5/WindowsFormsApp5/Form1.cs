...
namespace WindowsFormsApp5
{
    ...
    { 
        ...
        public void UpdateGeneral()
        {
            ...
            if (((AbilityScore)player.player_stats["str"]).GetScore() == 20) str_button.Visible = false;
            else str_button.Visible = true;

            if (((AbilityScore)player.player_stats["dex"]).GetScore() == 1) dex_button.Visible = false;
            else dex_button.Visible = true;

            if (((AbilityScore)player.player_stats["con"]).GetScore() == 20 ) cons_button.Visible = false;
            else cons_button.Visible = true;

            if (((AbilityScore)player.player_stats["int"]).GetScore() == 20 ) intel_button.Visible = false;
            else intel_button.Visible = true;

            if (((AbilityScore)player.player_stats["wis"]).GetScore() == 20 ) wis_button.Visible = false;
            else intel_button.Visible = true;

            if (((AbilityScore)player.player_stats["cha"]).GetScore() == 20 ) cha_button.Visible = false;
            else cha_button.Visible = true;

            if (((AbilityScore)player.player_stats["str"]).GetScore() == 1) str_minus.Visible = false;
            else str_minus.Visible = true;

            if (((AbilityScore)player.player_stats["dex"]).GetScore() == 1 ) dex_minus.Visible = false;
            else dex_minus.Visible = true; 

            if (((AbilityScore)player.player_stats["con"]).GetScore() == 1 ) con_minus.Visible = false;
            else con_minus.Visible = true;

            if (((AbilityScore)player.player_stats["int"]).GetScore() == 1 ) int_minus.Visible = false;
            else int_minus.Visible = true;

            if (((AbilityScore)player.player_stats["wis"]).GetScore() == 1 ) wis_minus.Visible = false;
            else wis_minus.Visible = true;

            if (((AbilityScore)player.player_stats["cha"]).GetScore() == 1 ) cha_minus.Visible = false;
